...
2. Configure global default dateline: admin/store/settings/products/edit/features
3. Configure the product class default dateline, target amount and functionality
   in: admin/store/products/classes
...
Theming
=======
The following variables are made available on the $node object for easy theming:
